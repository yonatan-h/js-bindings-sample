...
extension type GPUAdapter._(JSObject _) implements JSObject {
  ...
  /// [GPUAdapter] interface returns `true` if the adapter is a
  /// [fallback adapter](https://developer.mozilla.org/en-US/docs/Web/API/GPU/requestAdapter#fallback_adapters),
  /// and `false` if not.
