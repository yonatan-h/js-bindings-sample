...
extension type BluetoothRemoteGATTCharacteristic._(JSObject _)
  ...
  /// contained in a given `ArrayBuffer`,
  /// [writes the characteristic value with optional response](https://webbluetoothcg.github.io/web-bluetooth/#writecharacteristicvalue),
  ...
  /// property to the bytes contained in a given `ArrayBuffer`,
  /// [writes the characteristic value with required response](https://webbluetoothcg.github.io/web-bluetooth/#writecharacteristicvalue),
  /// and returns the resulting `Promise`.
  ...
  /// method sets a [BluetoothRemoteGATTCharacteristic] object's `value`
  /// property to the bytes contained in a given `ArrayBuffer`,
  /// [writes the characteristic value without response](https://webbluetoothcg.github.io/web-bluetooth/#writecharacteristicvalue),
  /// and returns the resulting `Promise`.
...
extension type BluetoothRemoteGATTDescriptor._(JSObject _) implements JSObject {
  ...
  /// For example `"00002902-0000-1000-8000-00805f9b34fb"` for the Client
