...
extension type Sanitizer._(JSObject _) implements JSObject {
  ...
  external void allowElement(SanitizerElementWithAttributes element);
  external void removeElement(SanitizerElement element);
  external void replaceElementWithChildren(SanitizerElement element);
  external void allowAttribute(SanitizerAttribute attribute);
  external void removeAttribute(SanitizerAttribute attribute);
  external void setComments(bool allow);
  external void setDataAttributes(bool allow);
  external void removeUnsafe();
}
