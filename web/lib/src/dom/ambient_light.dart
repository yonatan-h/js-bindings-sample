...
/// [MDN Web Docs](https://developer.mozilla.org/en-US/docs/Web/API/AmbientLightSensor).
extension type AmbientLightSensor._(JSObject _) implements Sensor, JSObject {
  ...
  /// The **`illuminance`** read-only property of the [AmbientLightSensor]
  /// interface returns the current light level in
  /// [lux](https://en.wikipedia.org/wiki/Lux) of the ambient light level around
  /// the hosting device.
